...
public final class JwtConstants {
    ...
    // JWT Error Messages
    public static final String ERROR_SECRET_NULL_OR_EMPTY = "JWT secret cannot be null or empty. Please configure app.jwt.secret in application.yml";
    public static final String ERROR_SECRET_TOO_SHORT = "JWT secret must be at least 32 bytes (256 bits) for HS256 algorithm. Current secret length: %d bytes. Please set a longer secret in app.jwt.secret configuration.";
    public static final String ERROR_SECRET_KEY_CREATION_FAILED = "Failed to create JWT secret key. Please ensure app.jwt.secret is properly configured.";
    ...
    public static final String LOG_SECRET_HASHED = "JWT secret was shorter than 32 bytes. It has been hashed to meet the requirement.";
